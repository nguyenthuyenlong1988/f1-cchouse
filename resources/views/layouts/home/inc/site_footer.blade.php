{{-- Created at 2015/05/27 04:31 htien Exp $ --}}

<nav id="navpanel" class="ivy-site-nav ivy-site-navpanel">
</nav>

<div id="bottombar" class="ivy-site-bottombar">

  <div id="footer-call-us" class="text-animated">
    <div class="ivy-page-wrapper">
      <div class="text-center">
        <div class="col-sm-8">
          <div class="title-container">
            <h2>Số gọi trực tiếp: 08-3916-30-89</h2>
        ...
        <div class="col-sm-4">
          <div class="button-container">
            <a class="btn btn-lg btn-animated" href="tel:+84839163089">
              Gọi ngay <span class="glyphicon glyphicon-earphone"></span>
            </a>
          </div>
        </div>
      </div>
