...
<div class="container-fluid">
  ...
  <table class="table ivy-table-center">
    <tbody>

      <tr> {{-- Address --}}
        <td class="text-right"><strong>
            <span class="glyphicon glyphicon-map-marker" aria-hidden="true"></span>
            <span class="sr-only">Địa Chỉ</span></strong>
        </td>
        <td>:</td>
        <td>Số 27, Đường số 9, Phường 16, Quận Gò Vấp, TP.HCM
      ...
      <tr> {{-- Phone --}}
        <td class="text-right"><strong>
            ...
            <span class="sr-only">Điện thoại</span></strong>
        </td>
        <td>:</td>
        <td>08.39163089</td>
      </tr>
      ...
      <tr> {{-- Facebook --}}
        <td class="text-right"><strong>
            ...
            <span class="sr-only">Facebook</span></strong>
        </td>
        <td>:</td>
        <td>Nhà Thiếu nhi Gò Vấp
      ...
      <tr> {{-- Website --}}
        <td class="text-right"><strong>
            ...
            <span class="sr-only">Website</span></strong>
        </td>
        <td>:</td>
        <td>www.NhaThieuNhiGoVap.com</td>
      </tr>
