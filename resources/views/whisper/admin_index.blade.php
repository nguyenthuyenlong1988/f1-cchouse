...
@section('page_title', 'Góc tâm sự')

@section('content')

<ol class="breadcrumb">
  <li><a href="{{ route('admin::index') }}">Vùng quản lý</a></li>
  <li class="active">Góc tâm sự</li>
</ol>
...
<div class="ivy-page-wrapper">
  ...
  <div class="panel panel-primary posts-list">
    <div class="panel-heading">
      <h2 class="title">
        <span class="literal">Góc tâm sự</span>
        <a class="btn btn-danger btn-sm" href="{{ route('admin::@dmin-zone.whisper.create') }}">
    ...
    <table class="table table-hover">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            <a href="{{ route('admin::@dmin-zone.whisper.show', $p->id) }}"><strong>{{ $p->post_title }}</strong></a>
          </td>
